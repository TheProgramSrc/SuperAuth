package xyz.theprogramsrc.superauth_v3.bungee;

import java.util.List;

import xyz.theprogramsrc.superauth_v3.bungee.commands.CrackedCommand;
import xyz.theprogramsrc.superauth_v3.bungee.commands.MainCommand;
import xyz.theprogramsrc.superauth_v3.bungee.commands.PremiumCommand;
...
public class SuperAuth extends BungeePlugin {
    ...
    public void onPluginEnable() {
        ...
        new MainCommand();
        this.log("Command '/superauth_v3' registered (Only for console)");
