package xyz.theprogramsrc.superauth_v3.spigot;
...
import xyz.theprogramsrc.superauth_v3.api.SuperAuthAPIHandler;
//import xyz.theprogramsrc.superauth_v3.global.CommandFilter;
...
import xyz.theprogramsrc.superauth_v3.spigot.commands.AuthCommand;
import xyz.theprogramsrc.superauth_v3.spigot.commands.LoginCommand;
import xyz.theprogramsrc.superauth_v3.spigot.commands.RegisterCommand;
import xyz.theprogramsrc.superauth_v3.spigot.commands.SuperAuthCommand;
import xyz.theprogramsrc.superauth_v3.spigot.listeners.BlockActionsListener;
import xyz.theprogramsrc.superauth_v3.spigot.listeners.IPSyncListener;
import xyz.theprogramsrc.superauth_v3.spigot.listeners.MainListener;
import xyz.theprogramsrc.superauth_v3.spigot.listeners.PreLoginListener;
import xyz.theprogramsrc.superauth_v3.spigot.listeners.SkinSyncListener;
import xyz.theprogramsrc.superauth_v3.spigot.memory.CaptchaMemory;
import xyz.theprogramsrc.superauth_v3.spigot.memory.ForceLoginMemory;
import xyz.theprogramsrc.superauth_v3.spigot.memory.WasRegisteredMemory;
import xyz.theprogramsrc.superauth_v3.spigot.objects.AuthAction;
...
public class SuperAuth extends SpigotPlugin {
    ...
    private void setupSettings(){
        ...
        if(!cfg.contains("MySQL.Enabled") || !cfg.contains("MySQL.Host") || !cfg.contains("MySQL.Port") || !cfg.contains("MySQL.DataBase") || !cfg.contains("MySQL.UserName") || !cfg.contains("MySQL.Password") || !cfg.contains("MySQL.UseSSL")){
            ...
            if(!cfg.contains("MySQL.DataBase")) cfg.add("MySQL.DataBase", "superauth_v3");
            if(!cfg.contains("MySQL.UserName")) cfg.add("MySQL.UserName", "superauth_v3");
    ...
    private void updateChecker(){
        ...
        if(this.getSettingsStorage().getConfig().getBoolean("UpdateChecker")){
            new SongodaUpdateChecker("superauth_v3-secure-your-users-and-server") {
                @Override
